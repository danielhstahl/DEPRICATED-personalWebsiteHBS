...
templates['creditRiskResearch'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class='txt'>\n  This project is a basic implementation of my credit risk model.  The full details can be found in my publication in the Journal of Credit Risk; in "
    ...
    + ".  The main innovations are the fast numerical implementation to compute the distribution and semi-endogenous liquidity risk.\n</div>\n<div class='txt'>\n  The parameters have the following interpretation:\n  <ul>\n"
