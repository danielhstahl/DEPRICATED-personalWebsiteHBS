...
templates['creditRiskResearch'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  ...
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += ") is also random. With few exceptions, the density\n  of the first hitting time of even a single dimensional Stochastic Differential Equation (SDE) is not explicitly known. However, finding the distribution numerically is not computationally difficult. The technique involves the characteristic function\n  of ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  ...
  buffer += " is defined as "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(9, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
  ...
  buffer += ". By Fourier's inversion theorem, "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(13, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "is "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(19, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
  ...
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(41, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  ...
  buffer += ". This is the most general process in a diffusion setting.\n</div>\n\n<div class='subTitle lead'>\n  <h3>Dynkan's Formula</h3>\n</div>\n<div class='txt'>\n  Dynkan's formula states the following: "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(45, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " Where ";
  ...
  buffer += " can be numerically inverted to recover the density. Recalling that the characteristic function is defined as "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(57, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " and letting ";
  ...
  buffer += ",\n  then by Dynkan's formula we have "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(61, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " With ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(63, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += ". ";
  ...
  buffer += " is then the solution to the ODE "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(67, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " With terminal condition\n  ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(69, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  ...
  buffer += ". This corresponds with the CEV model for stock price movements and is chosen due to being a relatively simple but interesting case: there are no analytic solutions to the distribution of the\n  first hitting time. The ODE that solves the characteristic function is "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(85, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "): "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(89, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    ...
    + " With ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(97, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += ". To incorporate these boundary conditions, the\n  solution of the matrix equation is "
    + ((stack1 = (helpers.tex || (depth0 && depth0.tex) || alias1).call(depth0,true,{"name":"tex","hash":{},"fn":this.program(99, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " Since this matrix is tri-diagonal, it can be solved in ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(101, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += " operations using the Thomas algorithm. The following code shows the Thomas algorithm in javascript:\n\n  <pre>\n    <code class=\"language-javascript txt\">\n      function thomas(a, b, c, psi){ //a, b, c, psi are vectors, a is complex //if b.length=a.length or c.length=a.length, only first n-1 records are used var n=a.length; //get number of records on diagonal for(var i=1<i>;</i> i<i><</i>n<i>;</i> i++){\n      //forward loop var gamHat= math.divide(c[i-1], a[i-1]); a[i]=math.add(a[i], math.multiply(-b[i-1],gamHat)); psi[i]=math.add(psi[i], math.multiply(-psi[i-1], gamHat)); } var phi=new Array(n+2); //the solution phi[n]=math.divide(psi[n-1], a[n-1]);\n      phi[0]=0; //boundaries phi[n+1]=1;//boundaries for(var i=(n-2); i>-1; i--){ //backward loop phi[i+1]=math.divide(math.add(psi[i], math.multiply(-b[i], phi[i+2])), a[i]); phi[i+2]=math.re(phi[i+2]); //only keep real part } phi[1]=math.re(phi[1]);\n      //only keep real part return phi; }\n    </code>\n  </pre>\n  This function numerically computes the ODE.\n  <pre>\n    <code class=\"language-javascript txt\">\n      function ode(n, alpha, sigma, mu, delta, m){ //number of discrete steps, drift, volatility, complex term, CEV parameter, barrier. var dx=m/(n-1); //the domain is [0, m] since a CEV process is always positive. var a=new Array(n-2);//first and last are\n      boundary conditions var b=new Array(n-2);//first and last are boundary conditions var c=new Array(n-2);//first and last are boundary conditions var psi=new Array(n-2);//first and last are boundary conditions var sigs=(sigma*sigma)/(dx*dx); for(var\n      i=0\n      <i>;</i> i\n      <(n-2)<i>;</i> i++){ //first and last are boundary conditions a[i]=math.subtract(math.complex(0, mu), math.pow(dx*(i+1), 2*delta)*sigs); b[i]=math.pow(dx*(i+1), 2*delta)*.5*sigs+.5*alpha*(i+1); c[i]=math.pow(dx*(i+2), 2*delta)*.5*sigs-.5*alpha*(i+2); //note\n        that x_{j+1} instead of x_j psi[i]=0; } psi[n-3]=-b[n-3]; //boundary condition var phi=thomas(a, b, c, psi); //solve equation return phi; }\n\n    </code>\n  </pre>\n\n  Oosterlee and Fang (2008) proposed a novel method to price European options for a very diverse set of asset models. This method relies on inverting the characteristic function of the underlying log price; and prices options with many strikes simultaneously.\n  Along the way they demonstrated the surprising accuracy of the method in computing the probability density from the characteristic function. Since the authors’ main goal was to price options they spent minimal time on this result. Two key characteristics\n  of this algorithm are the separate computations of the ";
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(81, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  buffer += " and ";
  ...
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(105, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  ...
  stack1 = ((helper = (helper = helpers.tex || (depth0 != null ? depth0.tex : depth0)) != null ? helper : alias1),(options={"name":"tex","hash":{},"fn":this.program(107, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.tex) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer + ".\n\n  <pre>\n    <code class=\"language-javascript txt\">\n\n      //function FangOosterlee(l, k, n, m, alpha, delta, sigma, X0, domObject){ //l is the number of u discretions, k is number of t-discretions, n is the discretions in the ODE solution, m is the hitting value, alpha is the drift of dX, delta is the power\n      of X (a value of one corresponds to B-S), and sigma is the volatility function FangOosterlee(options){ var n=options['n']; var k=options['k']; var l=options['l']; var m=options['m']; var alpha=options['alpha']; var delta=options['delta']; var sigma=options['sigma'];\n      var X0=m*.2;//hardcoded X0 for the sake of determining the size of t-space. This is not suitable for production! var exVal=math.abs(math.log(m/X0)/(alpha-.5*sigma*sigma)); //expected value of tau when delta=1, used for determining size of t-space\n      var std=math.sqrt(math.abs((math.log(m/X0)*sigma*sigma)/(math.pow(alpha-.5*sigma*sigma, 3)))); //standard deviation of tau when delta=1, used for determining size of t-space var xMax=exVal+5*std; //a range for t-space...production code would would\n      chebyshev's inequality to compute the range instead of an arbitrary \"5\" var lam=xMax/(k-1);//\"dt\" var dx=m/(n-1); //\"dx\" var du=Math.PI/xMax; //discrete u var cp=2/xMax; var phi=[];//array of arrays... var initial=ode(n, alpha, sigma, 0, delta,\n      m); //get solution of ODE for each u...this is not included in for loop since we need to multiply by .5 for(var i=0<i>;</i> i<i><</i>n<i>;</i> i++){ initial[i]=initial[i]*.5; } var denominator=n+l-1; phi.push(initial); for(var i=1<i>;</i>      i<i><</i>l<i>;</i> i++){ var updateRatio=(i*100)/denominator; self.postMessage({update: updateRatio+'%'}); //since this is a long running task, this is called asynchronously and posts updates of progress to the original thread phi.push(ode(n, alpha,\n      sigma, i*du, delta, m)); //get solution of ODE for each u } var soFar=i; var data={}; for(var h=0<i>;</i> h<i><</i>n<i>;</i> h++){ var updateRatio=((soFar+h)*100)/denominator; self.postMessage({update: updateRatio+'%'}); var key=Math.round(dx*h*10000)/10000.0;\n      key=key.toString(); data[key]=[]; var ySeries=[]; var xSeries=[]; for(var i=0<i>;</i> i<i><</i>k<i>;</i> i++){ //iterate over \"t\" discretions var y=0; for(var j=0<i>;</i> j<i><</i>n<i>;</i> j++){ y=y+phi[j][h]*math.cos(du*j*lam*i)*cp; } ySeries.push(y\n      ); xSeries.push(i*lam); } data[key]={Time: xSeries, Values: ySeries}; //put data in a manner that is easily readable } self.postMessage( {result:data}); }\n    </code>\n  </pre>\n\n</div>\n";
},"useData":true});
